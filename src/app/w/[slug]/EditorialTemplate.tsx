...
export default function EditorialTemplate({
  ...
  // Editorial always uses clean white — theme can't override
  ...
  return (
    <html lang="en" style={{ scrollBehavior: "smooth" }}>
      ...
      <body style={{ margin: 0, padding: 0, fontFamily: "'Inter', sans-serif", color: textColor, backgroundColor: background, lineHeight: 1.6, WebkitFontSmoothing: "antialiased" }}>
        ...
        {/* HERO — Split layout */}
        <section id="hero" style={{ minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr" }}>
          <div style={{ position: "relative", display: "flex", flexDirection: "column", justifyContent: "center", padding: "4rem 5rem", backgroundColor: primary, color: "#fff" }}>
            <p style={{ fontSize: "0.7rem", letterSpacing: "6px", textTransform: "uppercase", color: accent, marginBottom: "1rem", fontWeight: 600 }}>
              {config.tagline || "Together Forever"}
            </p>
            <h1 style={{ fontSize: "clamp(3rem, 6vw, 5.5rem)", fontFamily: "'Playfair Display', serif", fontWeight: 700, margin: "0 0 1rem", lineHeight: 1.05 }}>
              {wedding.name || "Our Wedding"}
            </h1>
            <div style={{ width: "60px", height: "3px", backgroundColor: accent, marginBottom: "1.5rem" }} />
            <p style={{ fontSize: "1rem", letterSpacing: "2px", textTransform: "uppercase", fontWeight: 300, color: "rgba(255,255,255,0.7)", marginBottom: "3rem" }}>
        ...
        {/* EVENTS — Grid cards */}
        <section id="events" style={{ padding: "6rem 4rem", maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "1.5rem" }}>
            {events.map((event: any, idx: number) => (
              <div key={event.id || idx} style={{ borderTop: `3px solid ${accent}`, padding: "2rem", backgroundColor: idx % 2 === 0 ? `${primary}04` : "transparent" }}>
        ...
        <section id="story" style={{ padding: "6rem 4rem", maxWidth: "800px", margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: "1rem", marginBottom: "0.5rem" }}>
        ...
        {/* TRAVEL — Clean cards */}
        <section id="travel" style={{ padding: "6rem 4rem", maxWidth: "1000px", margin: "0 auto", backgroundColor: `${primary}03` }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: "1rem", marginBottom: "0.5rem" }}>
          ...
          {travel.venueName && (
            <div style={{ marginBottom: "2.5rem", padding: "2.5rem", backgroundColor: "#fff", border: `1px solid ${primary}10` }}>
          ...
          {travel.hotels && travel.hotels.length > 0 && (
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1.5rem", marginBottom: "2rem" }}>
              {travel.hotels.map((hotel: any, idx: number) => (
                <div key={idx} style={{ padding: "2rem", backgroundColor: "#fff", border: `1px solid ${primary}10` }}>
        ...
        {/* REGISTRY */}
        <section id="registry" style={{ padding: "6rem 4rem", maxWidth: "800px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "1.5rem" }}>
            {registry.map((reg: any, idx: number) => (
              <div key={idx} style={{ padding: "2.5rem", textAlign: "center", borderTop: `3px solid ${accent}` }}>
        ...
        {/* FAQ */}
        <section id="faq" style={{ padding: "6rem 4rem", maxWidth: "800px", margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: "1rem", marginBottom: "3rem" }}>
        ...
        {/* RSVP */}
        <section id="rsvp" style={{ padding: "6rem 4rem", maxWidth: "600px", margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: "1rem", marginBottom: "0.5rem" }}>
          ...
          {submitSuccess ? (
            <div style={{ textAlign: "center", padding: "4rem 2rem", borderTop: `3px solid ${accent}` }}>
            ...
            <div>
              ...
              {selectedGuest && (
                <>
                  ...
                  <button onClick={onRsvpSubmit} disabled={!rsvpStatus || submitting} style={{ width: "100%", padding: "1rem", fontSize: "0.8rem", fontFamily: "'Inter', sans-serif", fontWeight: 700, letterSpacing: "3px", textTransform: "uppercase", backgroundColor: !rsvpStatus || submitting ? `${primary}33` : accent, color: "#fff", border: "none", cursor: !rsvpStatus || submitting ? "not-allowed" : "pointer" }}>
        ...
        {/* FOOTER */}
        <footer style={{ padding: "4rem", textAlign: "center", borderTop: `1px solid ${primary}10` }}>
          <p style={{ margin: "0 0 0.5rem", fontSize: "0.85rem", color: "#999" }}>Made with love</p>
